...
describe("Shapes", () => {
    ...
    //tests each class to ensure correct output
    describe("Triangle", () => {
...
<text x="150" y="150" font-size="50" text-anchor="middle" fill="blue">AAA</text>
</svg>`
...
<text x="100" y="145" font-size="60" text-anchor="middle" fill="blue">AAA</text>
</svg>`
...
<text x="150" y="120" font-size="60" text-anchor="middle" fill="blue">AAA</text>
</svg>`
